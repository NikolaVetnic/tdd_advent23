...
public class Task02Test
{
    ...
    {
        var games = Games.ParseFromFile(AppDomain.CurrentDomain.BaseDirectory + "../../../res/task02/task02_test-small.txt", new Roll(1, 1, 1));
    ...
    {
        var games = Games.ParseFromFile(AppDomain.CurrentDomain.BaseDirectory + "../../../res/task02/task02.txt", new Roll(12, 13, 14));
    ...
    {
        var games = Games.ParseFromFile(AppDomain.CurrentDomain.BaseDirectory + "../../../res/task02/task02_input.txt", new Roll(14, 12, 13));
