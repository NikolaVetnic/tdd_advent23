...
public class Task01Test
{
    ...
    {
        var filePath = AppDomain.CurrentDomain.BaseDirectory + "../../../res/task01/task01_test-small.txt";
    ...
    {
        var filePath = AppDomain.CurrentDomain.BaseDirectory + "../../../res/task01/task01_input.txt";
        var output = Task01.ParseFile(filePath);
